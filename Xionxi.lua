...
local function attackTarget(target: Model): boolean
	-- Connect this function to the legitimate combat system
	-- of an experience you own.
	--
	-- Do not put undocumented game remotes here.
...
local function autoFarmStep()
	if not State.AutoFarm
		or State.AutoLoot
		or not State.SelectedEnemy then
		return
	end
...
local function createToggle(
	...
	local button = createButton(name .. ": OFF")
	local enabled = false
...
Status.Size = UDim2.new(1, -4, 0, 38)
